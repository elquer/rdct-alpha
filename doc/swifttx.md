...
This mechanism has been integrated into Bitcore-Node-RDCT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/RDCT-Project/insight-api-rdct#web-socket-api](https://github.com/RDCT-Project/insight-api-rdct#web-socket-api) 
* API: [https://github.com/RDCT-Project/insight-api-rdct#swifttx-transactions](https://github.com/RDCT-Project/insight-api-rdct#swifttx-transactions) 
...
By default, the RDCT Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RDCT Core daemon:
