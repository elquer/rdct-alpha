...
In order to support loading of multiple wallets in rdct-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rdct.cpp.
...
Changes to rdct.cpp
----------------------
rdct.cpp is the entry point into rdct-qt, and as such, will require some minor modifications to provide hooks for
