Contributing to RDCT Core
============================

The RDCT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the RDCT Core project, and is not to be
confused with overall RDCT Network Protocol consensus changes.

Whether a pull request is merged into RDCT Core rests with the project merge
...
Patches that change RDCT consensus rules are considerably more involved than
...
Where a patch set proposes to change the RDCT consensus, it must have been
...
The project leader is the release manager for each RDCT Core release.
