                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RDCT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RDCT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rdct: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RDCT Core"), this);
    aboutAction->setStatusTip(tr("Show information about RDCT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RDCT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RDCT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RDCT addresses"));
    ...
    openAction->setStatusTip(tr("Open a RDCT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RDCT Core help message to get a list with possible RDCT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RDCT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RDCT network", "", count));
}
...
{
    QString strTitle = tr("RDCT Core"); // default title
