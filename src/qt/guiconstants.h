...
/* RDCT GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "RDCT"
#define QAPP_ORG_DOMAIN "rdct.org"
#define QAPP_APP_NAME_DEFAULT "RDCT-Qt"
#define QAPP_APP_NAME_TESTNET "RDCT-Qt-testnet"
