...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RDCT Core rdct-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rdct-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rdct transaction") + "\n" +
                               "  rdct-tx [options] -create [commands]   " + _("Create hex-encoded rdct transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rdct transaction
